...
Phase 0 of this project's phased build-out. No feature code in this phase — this sets up the conventions and CI gate every later phase builds on.
...
This section exists per this project's phase-lifecycle rule: update the spec when reality diverges, don't leave it aspirational.
