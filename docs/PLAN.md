...
- [ ] **Remaining spacing/typography calibration** — headline/subtitle exact sizing, the search bar's own dimensions, and the "limpar busca" button's exact padding are still HIG-default guesses, not measured. Update as more Dev Mode values come in.
